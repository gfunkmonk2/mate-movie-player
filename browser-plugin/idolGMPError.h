...
#ifndef __IDOL_GMP_ERROR_H__
#define __IDOL_GMP_ERROR_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolGMPError : public idolNPObject
{
  public:
    idolGMPError (NPP);
    virtual ~idolGMPError ();
...
IDOL_DEFINE_NPCLASS (idolGMPError);

#endif /* __IDOL_GMP_ERROR_H__ */
