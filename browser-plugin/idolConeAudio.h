...
#ifndef __IDOL_CONE_AUDIO_H__
#define __IDOL_CONE_AUDIO_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolConeAudio : public idolNPObject
{
  public:
    idolConeAudio (NPP);
    virtual ~idolConeAudio ();
...
IDOL_DEFINE_NPCLASS (idolConeAudio);

#endif /* __IDOL_CONE_AUDIO_H__ */
