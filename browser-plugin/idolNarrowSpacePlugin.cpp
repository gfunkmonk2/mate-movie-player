...
IDOL_IMPLEMENT_NPCLASS (idolNarrowSpacePlayer,
                         NULL, 0,
                         methodNames, G_N_ELEMENTS (methodNames),
                         NULL);

idolNarrowSpacePlayer::idolNarrowSpacePlayer (NPP aNPP)
  : idolNPObject (aNPP),
...
idolNarrowSpacePlayer::~idolNarrowSpacePlayer ()
{
  IDOL_LOG_DTOR ();
}

bool
idolNarrowSpacePlayer::InvokeByIndex (int aIndex,
                                       const NPVariant *argv,
                                       uint32_t argc,
                                       NPVariant *_result)
{
  IDOL_LOG_INVOKE (aIndex, idolNarrowSpacePlayer);
  ...
  switch (Methods (aIndex)) {
    ...
    case eGetStartTime:
      ...
      IDOL_WARN_1_INVOKE_UNIMPLEMENTED (aIndex, idolNarrowSpacePlayer);
    ...
    case eGetQuickTimeVersion:
      ...
      return StringVariant (_result, IDOL_NARROWSPACE_VERSION);
    ...
    case eGetNodeID:
      ...
      IDOL_WARN_INVOKE_UNIMPLEMENTED (aIndex, idolNarrowSpacePlayer);
      return Int32Variant (_result, 0);
