...
#ifndef __IDOL_GMP_CONTROLS_H__
#define __IDOL_GMP_CONTROLS_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolGMPControls : public idolNPObject
{
  public:
    idolGMPControls (NPP);
    virtual ~idolGMPControls ();
...
IDOL_DEFINE_NPCLASS (idolGMPControls);

#endif /* __IDOL_GMP_CONTROLS_H__ */
