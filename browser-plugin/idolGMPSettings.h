...
#ifndef __IDOL_GMP_SETTINGS_H__
#define __IDOL_GMP_SETTINGS_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolGMPSettings : public idolNPObject
{
  public:
    idolGMPSettings (NPP);
    virtual ~idolGMPSettings ();
...
IDOL_DEFINE_NPCLASS (idolGMPSettings);

#endif /* __IDOL_GMP_SETTINGS_H__ */
