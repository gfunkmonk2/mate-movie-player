...
#ifndef __IDOL_CONE_VIDEO_H__
#define __IDOL_CONE_VIDEO_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolConeVideo : public idolNPObject
{
  public:
    idolConeVideo (NPP);
    virtual ~idolConeVideo ();
...
IDOL_DEFINE_NPCLASS (idolConeVideo);

#endif /* __IDOL_CONE_VIDEO_H__ */
