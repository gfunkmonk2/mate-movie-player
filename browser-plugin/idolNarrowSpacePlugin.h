/* Idol NarrowSpace plugin scriptable
 *
...
class idolNarrowSpacePlayer : public idolNPObject
{
  public:
    idolNarrowSpacePlayer (NPP);
    virtual ~idolNarrowSpacePlayer ();
...
IDOL_DEFINE_NPCLASS (idolNarrowSpacePlayer);
