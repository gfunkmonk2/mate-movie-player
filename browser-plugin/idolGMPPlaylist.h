...
#ifndef __IDOL_GMP_PLAYLIST_H__
#define __IDOL_GMP_PLAYLIST_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolGMPPlaylist : public idolNPObject
{
  public:
    idolGMPPlaylist (NPP);
    virtual ~idolGMPPlaylist ();
...
IDOL_DEFINE_NPCLASS (idolGMPPlaylist);

#endif /* __IDOL_GMP_PLAYLIST_H__ */
