...
#ifndef __IDOL_GMP_PLAYER_H__
#define __IDOL_GMP_PLAYER_H__
...
class idolGMPPlayer : public idolNPObject
{
  public:
    idolGMPPlayer (NPP);
    virtual ~idolGMPPlayer ();
...
IDOL_DEFINE_NPCLASS (idolGMPPlayer);

#endif /* __IDOL_GMP_PLAYER_H__ */
