...
#ifndef __IDOL_CONE_PLAYLIST_ITEMS_H__
#define __IDOL_CONE_PLAYLIST_ITEMS_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolConePlaylistItems : public idolNPObject
{
  public:
    idolConePlaylistItems (NPP);
    virtual ~idolConePlaylistItems ();
...
IDOL_DEFINE_NPCLASS (idolConePlaylistItems);

#endif /* __IDOL_CONE_PLAYLIST_ITEMS_H__ */
