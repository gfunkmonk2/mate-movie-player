...
#ifndef __IDOL_MULLY_PLUGIN_H__
#define __IDOL_MULLY_PLUGIN_H__

#include "idolNPClass.h"
#include "idolNPObject.h"

class idolMullYPlayer : public idolNPObject
{
  public:
    idolMullYPlayer (NPP);
    virtual ~idolMullYPlayer ();
...
IDOL_DEFINE_NPCLASS (idolMullYPlayer);

#endif /* __IDOL_MULLY_PLUGIN_H__ */
