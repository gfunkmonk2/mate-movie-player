...
static void	idol_glow_button_set_timeout	(IdolGlowButton *button,
						 gboolean set_timeout);

static GtkButtonClass *parent_class;

G_DEFINE_TYPE (IdolGlowButton, idol_glow_button, GTK_TYPE_BUTTON);

static void
idol_glow_button_do_expose (IdolGlowButton *button)
{
	GdkRectangle area;
	GtkWidget *buttonw;
...
static gboolean
idol_glow_button_glow (IdolGlowButton *button)
{ 
	GtkWidget *buttonw;
	GtkAllocation allocation;
	GTimeVal tv;
	...
	if (button->screenshot == NULL) {
		...
		idol_glow_button_do_expose (button);
		if (button->screenshot == NULL)
			return TRUE;
	}
	...
	if (button->anim_finished != FALSE)
		idol_glow_button_set_timeout (button, FALSE);

	return button->anim_enabled;
}

static void
idol_glow_button_clear_glow_start_timeout_id (IdolGlowButton *button)
{ 
	button->button_glow = 0;
}

static void
cleanup_screenshots (IdolGlowButton *button)
{
	if (button->screenshot != NULL) {
...
static GdkPixmap *
take_screenshot (IdolGlowButton *button)
{
	GtkWidget *buttonw;
	GtkAllocation allocation;
	GtkStyle *style;
...
static gboolean
idol_glow_button_expose (GtkWidget        *buttonw,
			  GdkEventExpose   *event)
{
	IdolGlowButton *button;

	button = IDOL_GLOW_BUTTON (buttonw);
...
static void
idol_glow_button_map (GtkWidget *buttonw)
{
	IdolGlowButton *button;
	...
	if (button->glow != FALSE && button->button_glow == 0) {
		idol_glow_button_set_glow (button, TRUE);
	}
}

static void
idol_glow_button_unmap (GtkWidget *buttonw)
{
	IdolGlowButton *button;
...
static void
idol_glow_button_enter (GtkButton *buttonw)
{
	IdolGlowButton *button;
...
static void
idol_glow_button_leave (GtkButton *buttonw)
{
	IdolGlowButton *button;
	...
	if (button->glow != FALSE)
		idol_glow_button_set_timeout (button, TRUE);
}

static void
idol_glow_button_finalize (GObject *object)
{
	IdolGlowButton *button = IDOL_GLOW_BUTTON (object);

	idol_glow_button_set_glow (button, FALSE);
	cleanup_screenshots (button);
...
static void
idol_glow_button_class_init (IdolGlowButtonClass *klass)
{
	...
	object_class->finalize = idol_glow_button_finalize;
	widget_class->expose_event = idol_glow_button_expose;
	widget_class->map = idol_glow_button_map;
	widget_class->unmap = idol_glow_button_unmap;
	button_class->enter = idol_glow_button_enter;
	button_class->leave = idol_glow_button_leave;
}

static void
idol_glow_button_init (IdolGlowButton *button)
{
...
GtkWidget *
idol_glow_button_new (void)
{
	return g_object_new (IDOL_TYPE_GLOW_BUTTON, NULL);
}

static void
idol_glow_button_set_timeout (IdolGlowButton *button, gboolean set_timeout)
{
	if (set_timeout != FALSE) {
		...
		button->button_glow =
			g_timeout_add_full (G_PRIORITY_DEFAULT_IDLE,
					    100,
					    (GSourceFunc) idol_glow_button_glow, button,
					    (GDestroyNotify) idol_glow_button_clear_glow_start_timeout_id);
	} else {
		if (button->button_glow > 0) {
			g_source_remove (button->button_glow);
			button->button_glow = 0;
...
void
idol_glow_button_set_glow (IdolGlowButton *button, gboolean glow)
{
	GtkSettings *settings;
	gboolean anim_enabled;

	g_return_if_fail (IDOL_IS_GLOW_BUTTON (button));
	...
	idol_glow_button_set_timeout (button, glow);
}

gboolean
idol_glow_button_get_glow (IdolGlowButton *button)
{
