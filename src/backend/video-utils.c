...
void
idol_gdk_window_set_invisible_cursor (GdkWindow *window)
{
	GdkCursor *cursor;
...
void
idol_gdk_window_set_waiting_cursor (GdkWindow *window)
{
	GdkCursor *cursor;
...
char *
idol_time_to_string (gint64 msecs)
{
...
gint64
idol_string_to_time (const char *time_string)
{
...
char *
idol_time_to_string_text (gint64 msecs)
{
...
void
idol_widget_set_preferred_size (GtkWidget *widget, gint width,
				 gint height)
{
  IdolPrefSize *size = g_new (IdolPrefSize, 1);
...
gboolean
idol_ratio_fits_screen (GdkWindow *video_window, int video_width,
