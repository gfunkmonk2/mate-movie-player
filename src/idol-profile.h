...
#ifndef __IDOL_PROFILE_H__
#define __IDOL_PROFILE_H__ 1
...
#else /* MATE_ENABLE_DEBUG */

#define IDOL_PROFILE(function) function

#endif /* MATE_ENABLE_DEBUG */

#endif /* __IDOL_PROFILE_H__ */
