/* idol-sample-vala-plugin.c generated by valac, the Vala compiler
 * generated from idol-sample-vala-plugin.vala, do not modify */
...
static gboolean sample_vala_plugin_real_activate (IdolPlugin* base, IdolObject* idol, GError** error);
static void sample_vala_plugin_real_deactivate (IdolPlugin* base, IdolObject* idol);
SampleValaPlugin* sample_vala_plugin_new (void);
SampleValaPlugin* sample_vala_plugin_construct (GType object_type);
GType register_idol_plugin (GTypeModule* module);
...
static gboolean sample_vala_plugin_real_activate (IdolPlugin* base, IdolObject* idol, GError** error) {
	...
	g_return_val_if_fail (idol != NULL, FALSE);
...
static void sample_vala_plugin_class_init (SampleValaPluginClass * klass) {
	...
	IDOL_PLUGIN_CLASS (klass)->activate = sample_vala_plugin_real_activate;
	IDOL_PLUGIN_CLASS (klass)->deactivate = sample_vala_plugin_real_deactivate;
}
...
GType sample_vala_plugin_register_type (GTypeModule * module) {
	...
	sample_vala_plugin_type_id = g_type_module_register_type (module, IDOL_TYPE_PLUGIN, "SampleValaPlugin", &g_define_type_info, 0);
	return sample_vala_plugin_type_id;
}
