 ...
 **/
gchar *
idol_remove_file_extension (const gchar *filename)
{
	gchar	*p, *s;
 ...
 **/
gchar *
idol_change_file_extension (const gchar	*filename,
			     const gchar	*ext)
{
	...
	no_ext = idol_remove_file_extension (filename);
